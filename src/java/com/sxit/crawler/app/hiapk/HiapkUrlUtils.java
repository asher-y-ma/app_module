...
public class HiapkUrlUtils {
	...
	public String getUrl(String url,String referer){
		String url1=getLocation(url,referer);
		String resultUrl=null;
		if(url1!=null){
			if(url1.indexOf(".apk")!=-1){
				resultUrl=url1;
			}else{
				return url1=getUrl(url1,referer);
			}
		}
		return resultUrl;
	}
	private String getLocation(String url,String referer){
