...
public class AppStoreCrawlerModel extends CrawlModule {
	private static Logger log = LoggerFactory.getLogger(AppStoreCrawlerModel.class);
	private final static String DEFAULT_JOB_NAME = AppStoreCrawlerModel.class.getSimpleName();
